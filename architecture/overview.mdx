...
<CardGroup cols={2}>
  ...
  <Card title="IPC" icon="exchange" href="./ipc">
...
<CardGroup cols={2}>
  <Card title="Explore the Kernel" icon="microchip" href="./kernel">
    Deep dive into kernel architecture, subsystems, and design
  </Card>
  
  <Card title="Understand Userland" icon="users" href="./userland">
    Learn about services, applications, and the userspace environment
  </Card>
  
  <Card title="Study Libraries" icon="book" href="./libraries">
    Examine the library architecture and organization
  </Card>
  
  <Card title="Learn IPC" icon="exchange" href="./ipc">
